...
export const products = [
  ...
  { id: 5, name: "PlayStation 5", description: "Ultra-HD, 825GB SSD, Ray Graphics", rating: 4.5, price: "$499.99", imgSrc: assets.playstation_image },
...
export const dashboardNavItems: NavItem[] = [
  ...
  { title: "Orders", href: "/orders", roles: ["admin", "staff"] },
  { title: "Customers", href: "/customers", roles: ["admin", "staff"] },
