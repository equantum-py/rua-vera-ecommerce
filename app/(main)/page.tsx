...
const moda: HomeProduct[] = [
  { brand: "PARADISO", name: "Vestido Lino Vera", price: "Gs. 590.000", oldPrice: "Gs. 690.000", discount: 14, tone: "bg-[#d8cec5]", href: "/demo-product", imageUrl: "/brand/vestido-lino-vera.png" },
