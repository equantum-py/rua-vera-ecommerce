...
type HomeProduct = { brand: string; name: string; price: string; oldPrice: string; discount: number; tone: string; href: string; imageUrl?: string };

const moda: HomeProduct[] = [
  { brand: "PARADISO", name: "Vestido Lino Vera", price: "Gs. 590.000", oldPrice: "Gs. 690.000", discount: 14, tone: "bg-[#d8cec5]", href: "/shop?category=Moda", imageUrl: "/brand/vestido-lino-vera.png" },
